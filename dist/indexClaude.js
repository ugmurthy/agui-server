...
app.post("/awp", async (req, res) => {
    // Parse and validate the request body before setting any headers
    let input;
    try {
        ...
        // Return error before setting any SSE headers
    ...
    try {
        ...
        // For errors after SSE headers are set, we can't send a JSON response
        // Instead, send an error event through the SSE stream
        const errorEvent = {
